...
export default function ProductsForm({ content, onChange }: Props) {
    ...
    return (
        <div className="space-y-6">
            ...
            <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">URL de l'iFrame (Guide produit)</label>
                <input
                    type="text"
